...
Al termine del test, viene chiamato il \textit{callback} \texttt{onDone} con le seguenti informazioni:\begin{itemize}
	...
	\item \texttt{double sampleRate}: il \textit{sample rate} dell'\textit{array} \texttt{raw}, così da poter calcolare il \textit{timestamp} a cui corrisponde ogni \textit{sample}
\end{itemize}
