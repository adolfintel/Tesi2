...
\newglossaryentry{vrr}{
	name={VRR},
	description={Variable Refresh Rate, consente al display di variare il \textit{refresh rate} entro un certo intervallo, consentendo alla GPU di inviare i fotogrammi quando sono pronti, riducendo il ritardo ed eliminando il tearing senza bisogno di VSync. Lo standard si chiama VESA Adaptive Sync, i nomi commerciali sono Nvidia G-Sync e AMD Freesync.}
}
\newglossaryentry{frc}{
	name={LFC / FRC},
	description={Low Framerate Compensation, indica la capacità di un display con VRR di accettare segnali di frequenza inferiore al minimo supportato dal display.}
}
